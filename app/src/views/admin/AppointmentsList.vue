<template>
  <h1 class="text-center my-6">AppointementsList List</h1>
  <v-row class="pa-5">
      ...
      <div class="d-flex justify-center mb-2">
        <div class="container">
          ...
          <h3 class="my-10 text-center">
            The current page displays the appointments list, providing options to delete or modify
            appointments.
          </h3>
  ...
  <v-dialog v-if="selectedUser" v-model="showDeleteDialog" max-width="600">
    <v-card class="pa-5 bg-green-300" variant="outlined">
      ...
      <v-card-actions>
        ...
        <v-btn variant="tonal" color="red" text @click="deleteAppointment()">Delete</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
